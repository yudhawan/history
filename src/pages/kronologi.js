...
function Kronologi() {
  ...
  return (
    <div className='flex justify-center items-center'>
      {
        (sejarah || sejarah2 || sejarah3 || referensi)?<>
      ...
      <div className='flex flex-col lg:w-auto lg:px-10 w-80 h-auto py-8 rounded-lg bg-transparent backdrop-blur-md justify-center items-center space-y-2'>
        <div className='w-full flex px-3 justify-between'>
          <div className='font-semibold text-white text-xl px-2 rounded-md flex space-x-1 cursor-pointer' onClick={()=> navigate('/')}>
            <div className='flex justify-center items-center px-3 py-1 lg:py-0 lg:px-2 rounded-full bg-[#C55284]'><FontAwesomeIcon icon={faAngleLeft} size={'lg'} /> </div>
          </div>
          <div className='font-semibold text-white lg:text-xl text-sm bg-[#C55284] px-2 flex justify-center items-center rounded-md'>Section 2: Kronologi</div>
        </div>
        ...
        <div className='cursor-pointer active:animate-ping' onClick={handleSejarah}>
          ...
          <div className='bg-[#C55284] text-white py-1 px-2 text-center w-60 h-auto rounded-sm font-semibold'>Garis Besar Perkembangan Singhasari</div>
        </div>
        <div className='cursor-pointer active:animate-ping' onClick={handleSejarah2}>
          ...
          <div className='bg-[#C55284] text-white py-1 px-2 w-60 h-auto text-center rounded-sm font-semibold'>Puncak Kejayaan Singhasari</div>
        </div>
        <div className='cursor-pointer active:animate-ping' onClick={handleSejarah3}>
          <div className='bg-gray-600 rounded-sm w-60 h-32 justify-center flex items-center'>
            <img src={War} className='w-full h-full'/>
          </div>
          <div className='bg-[#C55284] text-white py-1 px-2 w-60 h-auto text-center rounded-sm font-semibold'>Keruntuhan Singhasari</div>
        </div>
        <div className='cursor-pointer active:animate-ping' onClick={handleReferensi}>
          <div className='bg-gray-600 rounded-sm w-60 h-32 justify-center flex items-center'>
            <img src={Books} className='w-full h-full'/>
          </div>
          <div className='bg-[#C55284] text-white py-1 px-2 w-60 h-auto text-center rounded-sm font-semibold'>Referensi</div>
        </div>
        </div>
      </div>
      }
