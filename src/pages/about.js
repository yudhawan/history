    ...
    <div className='flex justify-center items-center'>
      <div className='flex flex-col lg:w-[90vw] lg:px-10 w-96 h-auto py-8 rounded-lg bg-transparent backdrop-blur-md justify-center items-center space-y-2'>
        <div className={` w-full flex px-3 justify-between`}>
          <div className='relative self-start px-3 py-1 lg:py-1 lg:px-1 rounded-full bg-[#402E32] order-first text-white cursor-pointer' onClick={()=> navigate('/')}>
            <div className='flex justify-center items-center px-3 py-1 lg:py-0 lg:px-2 rounded-full bg-[#402E32]'><FontAwesomeIcon icon={faAngleLeft} size={'lg'} /> </div>
          </div>
          <div className='font-semibold text-white text-xl bg-[#402E32] px-2 rounded-md'>About</div>
        </div>
        <div className='flex lg:flex-row flex-col w-full bg-gray-500 bg-opacity-20 font-Ubuntu rounded-lg lg:p-4 p-2 lg:space-x-4 lg:w-[50vw]'>
          <div className='flex-col w-full lg:w-[25vw] text-white font-Ubuntu'>
            <div className='underline underline-offset-2 text-xl lg:text-2xl font-semibold'>About</div>
